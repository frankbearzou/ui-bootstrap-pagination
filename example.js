...
var PaginationDemoCtrl = function ($scope) {
  ...
  $scope.pageChanged = function() {
    ...
    $scope.data = datas.slice((($scope.currentPage-1)*$scope.itemsPerPage), (($scope.currentPage)*$scope.itemsPerPage));
